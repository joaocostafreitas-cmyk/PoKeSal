...
Crie uma Branch para a sua funcionalidade (git checkout -b feature/NovaFuncionalidade).

Confirme suas alterações (git commit -m 'Adiciona nova funcionalidade').

Envie para a sua Branch (git push origin feature/NovaFuncionalidade).

Abra um Pull Request detalhado explicando as mudanças efetuadas.
